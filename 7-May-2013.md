...
7 May 2013 (Tuesday) at [1200 Toronto](http://www.timeanddate.com/worldclock/fixedtime.html?msg=Eclipse+TM+May+Committer+Call&iso=20130507T12&p1=250&am=30)  
...
*   **Dave D**
    *   Review some 3.4.2 patches for DaveM (Done)
...
*   **Martin**
    *   Coordinate 3.4.3 build and release.
...
*   M7+1 was May 6 - This is API freeze. Update site completed, download site to be available soon.
...
*   Tuesday [TM/Meetings/4-June-2013](/TM/Meetings/4-June-2013 "TM/Meetings/4-June-2013") (4 weeks)

Minutes
-------

*   Dave Dykstal, Martin Oberhuber, Xuan Chen attending
*   Tycho versions plugin - causes pom.xml to match MANIFEST.MF
...
*   Upcoming release review -- Dave D to reschedule
    *   AI DaveD - Need to submit IP log 2 weeks prior
*   Apache commons.net
...
*   RC1+1 is on coming up on May 20. Capture will be May 17.
...
(Migrated from [https://wiki.eclipse.org/TM/Meetings/7-May-2013](https://wiki.eclipse.org/TM/Meetings/7-May-2013))